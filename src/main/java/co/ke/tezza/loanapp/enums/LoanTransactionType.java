...
public enum LoanTransactionType {
	...
	LOAN_DISBURSED("LOAN_DISBURSED", "Loan Disbursement"),
    ...
    BILL_OR_INVOICE_GENERATED("BILL_OR_INVOICE_GENERATED", "Bill/Invoice Generated"),
    BILL_INTEREST_ACCRUED("BILL_INTEREST_ACCRUED", "Interest Accrued On Bill/Invoice"),
    BILL_INTEREST_WAIVER("BILL_INTEREST_WAIVER", "Interest Waived On Bill/Invoice"),
    BILL_PENALTY_CHARGED("BILL_PENALTY_CHARGED", "Penalty Charged On Bill/Invoice"),
    BILL_PENALTY_WAIVER("BILL_PENALTY_WAIVER", "Penalty Waived On Bill/Invoice"),
    BILL_PENALTY_REVERSAL("BILL_PENALTY_REVERSAL", "Penalty Reversed On Bill/Invoice"),
    WALLET_DEPOSIT("WALLET_DEPOSIT", "Wallet Deposit"),
    WALLET_WITHDRAWAL("WALLET_WITHDRAWAL", "Wallet Deposit"),
    ...
    LoanTransactionType(String value, String description) {
        this.value = value;
    ...
    @JsonCreator
    public static LoanTransactionType forValues(@JsonProperty("value") String value,
                                                @JsonProperty("description") String description) {
        for (LoanTransactionType type : LoanTransactionType.values()) {
    ...
    public static LoanTransactionType getDefaultForOperation(String operation) {
