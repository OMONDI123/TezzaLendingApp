...
@Entity
@Table(name = "AD_Loan_Approval_History")
@AllArgsConstructor
@NoArgsConstructor
@Data
public class MLoanApprovalHistory extends AuditModel{
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Id
	@Column(name = "AD_Loan_Approval_History_ID")
	...
	@Column(name = "AD_Loan_Approval_History_UU", unique = true, nullable = false)
    private String AD_Loan_Approval_History=UUID.randomUUID().toString();
